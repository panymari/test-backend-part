...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\Product\ProductQuery::class,
                \App\GraphQL\Queries\Product\ProductsQuery::class,
                \App\GraphQL\Queries\Comment\CommentQuery::class,
                \App\GraphQL\Queries\Comment\CommentsQuery::class
            ],
            'mutation' => [
                ...
                \App\GraphQL\Mutations\Comment\CreateCommentMutation::class
            ],
            'types' => [
                \App\GraphQL\Types\Product\ProductType::class,
                \App\GraphQL\Types\Comment\CommentType::class,
                \App\GraphQL\Types\Product\SortingEnumProductType::class,
                \App\GraphQL\Types\Comment\SortingEnumCommentType::class,
            ],
